...
@PyroBotCMD.on_message(Filters.command(["clearnote", "clear"], COMMAND_HAND_LER) & sudo_filter)
...
@PyroBotCMD.on_message(Filters.command(["listnotes", "notes"], COMMAND_HAND_LER))
