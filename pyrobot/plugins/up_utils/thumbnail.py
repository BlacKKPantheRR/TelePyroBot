...
from pyrobot import COMMAND_HAND_LER, PyroBotCMD, TMP_DOWNLOAD_DIRECTORY
...
@PyroBotCMD.on_message(Filters.command("savethumbnail", COMMAND_HAND_LER) & sudo_filter)
...
@PyroBotCMD.on_message(Filters.command("clearthumbnail", COMMAND_HAND_LER)  & sudo_filter)
...
@PyroBotCMD.on_message(Filters.command("getthumbnail", COMMAND_HAND_LER)  & sudo_filter)
