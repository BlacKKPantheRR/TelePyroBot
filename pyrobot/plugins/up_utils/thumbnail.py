...
from pyrobot import COMMAND_HAND_LER, app, TMP_DOWNLOAD_DIRECTORY
...
@app.on_message(Filters.command("savethumbnail", COMMAND_HAND_LER) & sudo_filter)
...
@app.on_message(Filters.command("clearthumbnail", COMMAND_HAND_LER)  & sudo_filter)
...
@app.on_message(Filters.command("getthumbnail", COMMAND_HAND_LER)  & sudo_filter)
